...
```bash
sudo dnf install i3-gaps rofi polybar tmux alacritty neovim zsh xss-lock xautolock xset scrot wmctrl ImageMagick dunst gh brightnessctl fzf fd-find ripgrep
```
